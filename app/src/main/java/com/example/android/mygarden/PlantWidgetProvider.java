...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Log.d(TAG, "updateAppWidget: " +imgRes);
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int appWidgetId : appWidgetIds) {
            Log.d(TAG, "updatePlantWidgets: "+appWidgetId);
    ...
    private static RemoteViews getSinglePlantRemoteView(Context context, int imgRes, long plantId, boolean showWater) {
        ...
        if (showWater){
            Log.d(TAG, "getSinglePlantRemoteView: showWater"+showWater);
...
//        Intent intent = new Intent(mcontext.getApplicationContext(), PlantWateringService.class);
//        intent.setAction(ACTION_UPDATE_PLANT_WIDGETS);
//        PendingIntent pending = PendingIntent.getService(mcontext.getApplicationContext(), 0, intent, 0);
